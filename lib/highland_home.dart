...
//   // **** FIX: RENAME THESE CONTROLLERS TO MATCH WHAT THE UI IS USING ****
...
//   //                                       child: Container(
//   //                                         width:
//   //                                             220, // 🟧 Reduced width for smaller button
//   //                                         height: 50,
//   //                                         decoration: BoxDecoration(
//   //                                           color: Color(
//   //                                               0xFFEE9821), // Orange color
//   //                                           borderRadius:
//   //                                               BorderRadius.circular(8.0),
//   //                                           border: Border.all(
//   //                                               color: Colors.yellow),
...
//                           child: Form(
//                             // <-- WRAP WITH FORM
//                             key: _desktopBookingFormKey, // <-- ASSIGN KEY
//                             child: Column(
//                                 crossAxisAlignment: CrossAxisAlignment.center,
//                                 mainAxisAlignment:
//                                     MainAxisAlignment.spaceEvenly,
...
//             child: Column(
//               children: [
//                 Text('''Request a callback from our team'''),
//                 SizedBox(height: isMobile ? 15 : 20),
//                 if (isMobile) ...[
...
//   Widget _buildAppointmentButtonsResponsive(
//       BuildContext context, bool isMobile, double buttonSize) {
//     // 🟧 Single "Request Callback" button
...
//       },
//       style: ElevatedButton.styleFrom(
//         backgroundColor: const Color(0xFFEE9821), // Orange color
//         foregroundColor: Colors.black,
//         padding: EdgeInsets.symmetric(
//           vertical: isMobile ? 10 : 12,
...
//     // 🧭 Responsive layout
//     if (isMobile) {
//       // For mobile — center with limited width
//       return Center(
//         child: SizedBox(
//           width: 220, // smaller button on mobile
//           child: requestCallbackButtonWidget,
//         ),
//       );
//     } else {
//       // For desktop — centered button with larger width
//       return Row(
//         mainAxisAlignment: MainAxisAlignment.center,
//         children: [
//           SizedBox(
...
class _HighlandhomeState extends State<Highlandhome>
  ...
  Widget build(BuildContext context) {
    ...
    double bodyTextSmall = isMobile ? 18 : (isTablet ? 20 : 16);
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: bookingController.isLoading
                        ? null
                        : () async {
                            if (_responsiveBookingFormKey.currentState!
                                .validate()) {
                              final enquiry = BookingEnquiry(
                                firstName: _desktopBookFirstNameController.text,
                                lastName: _desktopBookLastNameController.text,
                              ...
                              await controller
                                ...
                                if (success) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                        content:
                                            Text(controller.successMessage!),
                                        backgroundColor: Colors.green),
                                  );
