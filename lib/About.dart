  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          Row(children: [
            // GestureDetector(
            //   onTap: () => onMenuItemTapped(menuItems[0]),
            //   child: Text(
            //     menuItems[0],
            //     style: TextStyle(
            //       fontSize: 20,
            ...
            //   ),
            // ),
            Spacer(), // Pushes the remaining menu items to the right
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: List.generate(menuItems.length - 1, (index) {
                return GestureDetector(
                  onTap: () => onMenuItemTapped(menuItems[index + 1]),
                  child: menuItems[index + 1] == 'CONTACT'
                      ? Container(
          ...
          Padding(
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: Colors
                        .grey[100], // Light background color for the container
                    boxShadow: [
                      BoxShadow(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image:
                              AssetImage("assets/img/Dr.c.p.abdul rahman.jpg"),
                          fit: BoxFit.cover,
                        ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image:
                            AssetImage("assets/img/Dr.c.p.abdulla yasser.jpg"),
                        fit: BoxFit.cover,
                      ),
                      borderRadius: BorderRadius.circular(15),
                      boxShadow: [
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage("assets/img/Mr.Mohammed yoonus.jpg"),
                        fit: BoxFit.cover,
                      ),
                      borderRadius: BorderRadius.circular(15),
                      boxShadow: [
...
// Below part with health tips, news, and visiting hours
          Stack(children: [
            ...
            Container(
              ...
              height: 330, // Fixed height but can adjust based on design needs
